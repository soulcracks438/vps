...
void usage() {
    std::cout << "• Welcome to Black Hat DDoS •\n\n• Usage following format:\n• → ./blackhat <target> <port> <duration> <threads>\n\nPowered : @BlackHatDDoS\n";
    exit(1);
}
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Attack started successfully on" << ip << ":" << port << " for " << duration << " seconds with " << threads << " threads\nPowered by Black Hat DDoS\n";
    ...
    for (int i = 0; i < threads; i++) {
        ...
        std::cout << "Launched Black thread with ID: " << thread_ids[i] << "\n";
    }
    ...
    std::cout << "Attack finished successfully. Binary credit by : @BlackHatDDoS\n";
    return 0;
}
//g++ -std=c++14 BGMI.cpp -o BGMI -pthread
